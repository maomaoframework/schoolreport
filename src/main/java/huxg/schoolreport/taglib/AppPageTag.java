...
public class AppPageTag extends BodyTagSupport {
	...
	public int doStartTag() throws JspException {
		if (useSkin) {
			...
			sb.append("	<title>").append(StringUtils.isEmpty(title) ? SysConfiguration.getProperty("system.name") : title).append("</title>\r\n");
			sb.append("	<meta content=\"width=device-width, initial-scale=1.0\" name=\"viewport\" />\r\n");
			sb.append("	<meta content=\"").append(StringUtils.isEmpty(description) ? SysConfiguration.getProperty("meta.description") : description).append("\" name=\"description\" />\r\n");
			sb.append("	<meta content=\"").append(StringUtils.isEmpty(author) ? SysConfiguration.getProperty("meta.author") : author).append("\" name=\"author\" />\r\n");
			sb.append("	<!-- 全局样式定义 -->\r\n");
			...
			sb.append("	<!-- 页面样式定义 --> \r\n");
			sb.append("	<link rel=\"shortcut icon\" href=\"" + SysConfiguration.getProperty("system.static_server") + "/themes/app/images/favicon.ico\" />\r\n");
			...
			sb.append("<script src=\"").append(SysConfiguration.getProperty("system.static_server") + "/script/app/app.ms.js\" type=\"text/javascript\"></script>");
			sb.append("");
